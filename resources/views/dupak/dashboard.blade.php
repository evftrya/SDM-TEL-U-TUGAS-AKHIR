            ...
            <div class="p-6 text-gray-900">
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                    ...
                    <div class="col-span-1 p-6 bg-white border border-gray-200 rounded-lg shadow md:col-span-2">
                        ...
                        $updatedAt = $user->kum_updated_at ?? null;
                        @endphp
                        ...
                        <div class="mt-4">
                            ...
                            @if($updatedAt)
                            <div class="mt-2 text-xs text-gray-500">Terakhir diperbarui: {{ \Carbon\Carbon::parse($updatedAt)->diffForHumans() }}</div>
                            @endif
                        </div>
                    ...
                    <div class="p-6 bg-white border border-gray-200 rounded-lg shadow">
                        ...
                        <a href="{{ route('dupak.validasi.index') }}" class="inline-block px-4 py-2 text-white bg-green-600 rounded hover:bg-green-700">
                            Validasi Pengajuan
                        </a>
                    </div>
                    @endif
