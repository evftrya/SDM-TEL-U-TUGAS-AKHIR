    ...
    <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                <h1 class="mb-3 text-2xl font-semibold">Pengajuan DUPAK</h1>
                    ...
                    <div class="p-4 rounded-lg bg-gray-50">
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                            <div>
                                ...
                                <input type="text" name="current_position" id="current_position" value="{{ auth()->user()->jabatan_fungsional ?? 'Belum ada jabatan' }}"
                                    class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                    readonly>
                            </div>
                            ...
                            <div>
                                ...
                                <select name="target_position" id="target_position" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required>
