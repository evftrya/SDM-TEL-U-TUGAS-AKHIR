...
<div id="detailModal" class="fixed inset-0 z-50 hidden flex items-center justify-center">
    ...
    <div class="relative bg-white rounded-lg shadow-xl w-full max-w-sm mx-4 overflow-hidden z-10">
        ...
        <div class="text-center px-6 pt-6">
            <h2 class="text-3xl font-semibold text-gray-900">Detail Fakultas</h2>
        </div>
        ...
        <div class="p-6 space-y-4">
            <!-- Kode Fakultas -->
            <div>
                <label class="block text-sm font-semibold text-gray-700 mb-1">Kode Fakultas</label>
                <div id="detail_kode_fakultas"
            ...
            <!-- Jumlah Prodi -->
            <div>
                <label class="block text-sm font-semibold text-gray-700 mb-1">Jumlah Program Studi</label>
                <div id="detail_jumlah_prodi"
                    class="w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-50 text-gray-800">
                    -
                </div>
            </div>
