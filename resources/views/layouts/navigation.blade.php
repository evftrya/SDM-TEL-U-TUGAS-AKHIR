<nav x-data="{ open: false }" class="bg-blue-950 border-b border-gray-100 dark:bg-gray-800 dark:border-gray-700">
    <!-- Primary Navigation Menu -->
    {{-- <div class="px-4 mx-2 max-w-7xl sm:px-6 lg:px-8"> --}}
    <div class="px-4 mx-3 max-w-full sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:justify-center sm:flex-1">
                <div class="space-x-8 sm:flex text-white">
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1 text-white">
            <x-responsive-nav-link :href="route('home')" :active="request()->routeIs('home')">
                <p class="text-white clear-p">Beranda</p>
                    ...
                    <div class="mt-3 space-y-1">
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <x-responsive-nav-link :href="route('logout')"
                                ...
                                {{-- {{ __('Log Out') }} --}}
                                <p class="text-white clear-p">{{ __('Log Out') }}</p>
